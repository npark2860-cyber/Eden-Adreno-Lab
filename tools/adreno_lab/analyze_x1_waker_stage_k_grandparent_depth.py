#!/usr/bin/env python3
# Normalize Stage K selected-producer PC/LR/parent/grandparent contexts with Stage H ranges.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Normalize Stage K grandparent caller contexts")
