...
private:
    ...
    void WriteCtrEl0Handler(ModuleDestLabel module_dest, oaknut::XReg dest_reg, oaknut::VectorCodeGenerator& code);
    ...
    void WriteCtrEl0Handler(ModuleDestLabel module_dest, oaknut::XReg dest_reg) { WriteCtrEl0Handler(module_dest, dest_reg, c); }
